...
def console_reader(inp='i'):
    ...
    if inp == 'p':
        ...
        #this fucking worked jesus fuck holy shit absolutely wasting my time i legit despise this location the decryptor was even wrong the whole time and i just let it happen
